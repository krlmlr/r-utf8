...
- Bump version to 1.2.6.9008 (#97).

- Bump version to 1.2.6.9007 (#95).
...
- Install binaries from r-universe for dev workflow (#90).
...
- Auto-update from GitHub Actions (#84).
